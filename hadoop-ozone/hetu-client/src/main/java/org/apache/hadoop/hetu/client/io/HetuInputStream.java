 ...
 * It uses {@link TabletInputStream} for reading the data.
 */
public class HetuInputStream extends InputStream implements CanUnbuffer,
    ByteBufferReadable {

  private final InputStream inputStream;

  public HetuInputStream() {
    inputStream = null;
  }
  /**
   * Constructs OzoneInputStream with TabletInputStream.
   *
   * @param inputStream
   */
  public HetuInputStream(InputStream inputStream) {
