...
package org.apache.hadoop.hetu.om.ratis.utils;

import com.google.common.base.Preconditions;
import org.apache.hadoop.hdds.conf.OzoneConfiguration;
import org.apache.hadoop.hdds.utils.HAUtils;
import org.apache.hadoop.hetu.om.OzoneManager;
import org.apache.hadoop.hetu.om.codec.OMDBDefinition;
import org.apache.hadoop.ozone.om.exceptions.OMException;
import org.apache.hadoop.hdds.utils.TransactionInfo;
import org.apache.hadoop.hetu.om.request.bucket.OMBucketCreateRequest;
import org.apache.hadoop.hetu.om.request.bucket.OMBucketDeleteRequest;
import org.apache.hadoop.hetu.om.request.bucket.OMBucketSetPropertyRequest;
import org.apache.hadoop.hetu.om.request.OMClientRequest;
import org.apache.hadoop.hetu.om.request.bucket.acl.OMBucketAddAclRequest;
import org.apache.hadoop.hetu.om.request.bucket.acl.OMBucketRemoveAclRequest;
import org.apache.hadoop.hetu.om.request.bucket.acl.OMBucketSetAclRequest;
import org.apache.hadoop.hetu.om.request.database.OMDatabaseCreateRequest;
import org.apache.hadoop.hetu.om.request.database.OMDatabaseDeleteRequest;
import org.apache.hadoop.hetu.om.request.file.OMDirectoryCreateRequest;
import org.apache.hadoop.hetu.om.request.file.OMFileCreateRequest;
import org.apache.hadoop.hetu.om.request.key.OMKeysDeleteRequest;
import org.apache.hadoop.hetu.om.request.key.OMAllocateBlockRequest;
import org.apache.hadoop.hetu.om.request.key.OMKeyCommitRequest;
import org.apache.hadoop.hetu.om.request.key.OMKeyCreateRequest;
import org.apache.hadoop.hetu.om.request.key.OMKeyDeleteRequest;
import org.apache.hadoop.hetu.om.request.key.OMKeyPurgeRequest;
import org.apache.hadoop.hetu.om.request.key.OMKeyRenameRequest;
import org.apache.hadoop.hetu.om.request.key.OMKeysRenameRequest;
import org.apache.hadoop.hetu.om.request.key.OMTrashRecoverRequest;
import org.apache.hadoop.hetu.om.request.key.acl.OMKeyAddAclRequest;
import org.apache.hadoop.hetu.om.request.key.acl.OMKeyRemoveAclRequest;
import org.apache.hadoop.hetu.om.request.key.acl.OMKeySetAclRequest;
import org.apache.hadoop.hetu.om.request.key.acl.prefix.OMPrefixAddAclRequest;
import org.apache.hadoop.hetu.om.request.key.acl.prefix.OMPrefixRemoveAclRequest;
import org.apache.hadoop.hetu.om.request.key.acl.prefix.OMPrefixSetAclRequest;
import org.apache.hadoop.hetu.om.request.s3.multipart.S3InitiateMultipartUploadRequest;
import org.apache.hadoop.hetu.om.request.s3.multipart.S3MultipartUploadAbortRequest;
import org.apache.hadoop.hetu.om.request.s3.multipart.S3MultipartUploadCommitPartRequest;
import org.apache.hadoop.hetu.om.request.s3.multipart.S3MultipartUploadCompleteRequest;
import org.apache.hadoop.hetu.om.request.s3.security.S3GetSecretRequest;
import org.apache.hadoop.hetu.om.request.s3.security.S3RevokeSecretRequest;
import org.apache.hadoop.hetu.om.request.security.OMCancelDelegationTokenRequest;
import org.apache.hadoop.hetu.om.request.security.OMGetDelegationTokenRequest;
import org.apache.hadoop.hetu.om.request.security.OMRenewDelegationTokenRequest;
...
import org.apache.hadoop.hetu.om.request.table.OMTableSetPropertyRequest;
import org.apache.hadoop.hetu.om.request.volume.OMVolumeCreateRequest;
import org.apache.hadoop.hetu.om.request.volume.OMVolumeDeleteRequest;
import org.apache.hadoop.hetu.om.request.volume.OMVolumeSetOwnerRequest;
import org.apache.hadoop.hetu.om.request.volume.OMVolumeSetQuotaRequest;
import org.apache.hadoop.hetu.om.request.volume.acl.OMVolumeAddAclRequest;
import org.apache.hadoop.hetu.om.request.volume.acl.OMVolumeRemoveAclRequest;
import org.apache.hadoop.hetu.om.request.volume.acl.OMVolumeSetAclRequest;
...
//        return new OMSetDatabasePropertyRequest(omRequest);
  ...
  /**
   * Convert exception result to {@link Status}.
   * @param exception
