...
/**
 * Response for CommitTablet request.
 */
@CleanupTableInfo(cleanupTables = {OPEN_TABLET_TABLE, TABLET_TABLE})
public class OMTabletCommitResponse extends OMClientResponse {

  private OmTabletInfo omTabletInfo;
  private String ozoneTabletName;
  private String openTabletName;
  private OmPartitionInfo omPartitionInfo;

  public OMTabletCommitResponse(@Nonnull OMResponse omResponse,
                                @Nonnull OmTabletInfo omTabletInfo, String ozoneTabletName, String openTabletName,
                                @Nonnull OmPartitionInfo omPartitionInfo) {
    super(omResponse);
    this.omTabletInfo = omTabletInfo;
    this.ozoneTabletName = ozoneTabletName;
    this.openTabletName = openTabletName;
  ...
  public void addToDBBatch(OMMetadataManager omMetadataManager,
    ...
    // Delete from OpenTablet table
    omMetadataManager.getOpenTabletTable().deleteWithBatch(batchOperation,
        openTabletName);

    omMetadataManager.getTabletTable().putWithBatch(batchOperation, ozoneTabletName,
        omTabletInfo);
