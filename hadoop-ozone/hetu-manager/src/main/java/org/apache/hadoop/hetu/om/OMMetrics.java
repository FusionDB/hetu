...
public class OMMetrics {
  ...
  private @Metric MutableCounterLong numTableInfos;
  private @Metric MutableCounterLong numTableLists;
  ...
  private @Metric MutableCounterLong numPartitionInfos;
  ...
  private @Metric MutableCounterLong numTableInfoFails;
  private @Metric MutableCounterLong numTableListFails;
  ...
  private @Metric MutableCounterLong numPartitionInfoFails;
  private @Metric MutableCounterLong numPartitionListFails;
  ...
  @VisibleForTesting
  public long getNumTableInfos() {
    return numTableInfos.value();
  }

  @VisibleForTesting
  public long getNumPartitionInfos() {
    return numPartitionInfos.value();
  }
  ...
  @VisibleForTesting
  public long getNumTableLists() {
    return numTableLists.value();
  }

  @VisibleForTesting
  public long getNumPartitionLists() {
    return numPartitionLists.value();
  }
  ...
  @VisibleForTesting
  public long getNumTableInfoFails() {
  ...
  public long getNumPartitionInfoFails() {
    return numPartitionInfoFails.value();
  }
  ...
  @VisibleForTesting
  public long getNumTableListFails() {
    return numTableListFails.value();
  }

  @VisibleForTesting
  public long getNumPartitionListFails() {
    return numPartitionListFails.value();
  }
  ...
  public void incNumTableInfos() {
    numTableOps.incr();
    numTableInfos.incr();
  }

  public void incNumTableInfoFails() {
    numTableInfoFails.incr();
  }

  public void incNumTableLists() {
    numTableOps.incr();
    numTableLists.incr();
  }

  public void incNumTableListFails() {
    numTableListFails.incr();
  }

  public void incNumPartitionInfos() {
    numPartitionOps.incr();
    numPartitionInfos.incr();
  }

  public void incNumPartitionInfoFails() {
    numPartitionInfoFails.incr();
  }

  public void incNumPartitionLists() {
    numPartitionOps.incr();
    numPartitionLists.incr();
  }
