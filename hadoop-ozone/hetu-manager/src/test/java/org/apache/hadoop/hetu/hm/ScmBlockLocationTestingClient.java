...
/**
 * This is a testing client that allows us to intercept calls from HetuManager
 * to SCM.
 * <p>
 * TODO: HetuManager#getScmBlockClient -- so that we can load this class up via
 * config setting into HetuManager. Right now, we just pass this to
 * TabletDeletingService only.
 * <p>
 * TODO: Move this class to a generic test utils so we can use this class in
 * other Hetu Manager tests.
 */
