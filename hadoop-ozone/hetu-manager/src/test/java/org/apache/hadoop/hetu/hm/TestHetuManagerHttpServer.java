...
import org.apache.hadoop.hetu.om.OzoneManagerHttpServer;
...
public class TestHetuManagerHttpServer {
  private static final String BASEDIR = GenericTestUtils
      .getTempPath(TestHetuManagerHttpServer.class.getSimpleName());
  ...
  @Parameters public static Collection<Object[]> policy() {
    Object[][] params = new Object[][] {
        {Policy.HTTP_ONLY},
        {Policy.HTTPS_ONLY},
        {Policy.HTTP_AND_HTTPS} };
    return Arrays.asList(params);
  }

  private final Policy policy;

  public TestHetuManagerHttpServer(Policy policy) {
    super();
    this.policy = policy;
  }
  ...
  @BeforeClass public static void setUp() throws Exception {
    ...
    sslConfDir = KeyStoreTestUtil.getClasspathDir(
        TestHetuManagerHttpServer.class);
  ...
  @Test public void testHttpPolicy() throws Exception {
    ...
    try {
      ...
      DefaultMetricsSystem.initialize("TestHetuManagerHttpServer");
      server.start();
