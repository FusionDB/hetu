...
import org.apache.hadoop.hetu.photon.proto.PhotonSchemaProtocolProtos.*;
...
public class Schema {
    ...
    public SchemaProto toProtobuf() {
        List<ColumnSchemaProto> columnSchemaProtos = columnsByIndex.stream()
                .map(columnSchema -> columnSchema.toProtobuf())
                .collect(Collectors.toList());

        SchemaProto builder = SchemaProto.newBuilder()
    ...
    public static Schema fromProtobuf(SchemaProto schemaProto) {
