...
public abstract class RowResult {
    ...
    public final Date getDate(int columnIndex) {
        ...
        checkType(columnIndex, ColumnType.DATE);
    ...
    public final String getString(int columnIndex) {
        checkType(columnIndex, ColumnType.STRING);
    ...
    public final String getVarchar(int columnIndex) {
        checkType(columnIndex, ColumnType.VARCHAR);
        return getVarLengthData(columnIndex);
    }
     ...
     *  ColumnType.BOOL -> java.lang.Boolean
     *  ColumnType.INT8 -> java.lang.Byte
     *  ColumnType.INT16 -> java.lang.Short
     *  ColumnType.INT32 -> java.lang.Integer
     *  ColumnType.INT64 -> java.lang.Long
     *  ColumnType.UNIXTIME_MICROS -> java.sql.Timestamp
     *  ColumnType.FLOAT -> java.lang.Float
     *  ColumnType.DOUBLE -> java.lang.Double
     *  ColumnType.VARCHAR -> java.lang.String
     *  ColumnType.STRING -> java.lang.String
     *  ColumnType.BINARY -> byte[]
     *  ColumnType.DECIMAL -> java.math.BigDecimal
     *
     * @param columnName name of the column in the schema
     ...
     * @return a type
     */
    public final ColumnType getColumnType(String columnName) {
        return this.schema.getColumn(columnName).getColumnType();
    }
    ...
    public final ColumnType getColumnType(int columnIndex) {
        return this.schema.getColumnByIndex(columnIndex).getColumnType();
    }
    ...
    protected final void checkNull(int columnIndex) {
        ...
        if (isNull(columnIndex)) {
            ...
            throw new IllegalArgumentException("The requested column (name: " + columnSchema.getColumnName() +
                    ", index: " + columnIndex + ") is null");
        }
    }

    protected final void checkType(int columnIndex, ColumnType... types) {
        ColumnSchema columnSchema = schema.getColumnByIndex(columnIndex);
        ColumnType columnType = columnSchema.getColumnType();
        for (ColumnType type : types) {
            if (columnType.equals(type)) {
                return;
            }
        }
        throw new IllegalArgumentException("Column (name: " + columnSchema.getColumnName() +
