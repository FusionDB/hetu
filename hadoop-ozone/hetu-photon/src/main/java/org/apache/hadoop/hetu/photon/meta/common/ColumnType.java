...
public enum ColumnType {
     ...
     */
    ColumnType(DataType dataType, String name) {
        this.dataTypes = ImmutableList.of(dataType);
        this.name = name;
        this.size = getTypeSize(dataType);
    }

    ColumnType(List<DataType> dataTypes, String name) {
     ...
     */
    public static ColumnType getTypeForDataType(DataType type) {
        switch (type) {
            case STRING:
                return STRING;
            case BINARY:
            ...
            default:
                throw new IllegalArgumentException("The provided data type doesn't map" +
                        " to know any known one: " + type.name());
     ...
     * @return a matching Type.
     */
    public static ColumnType getTypeForName(String name) {
