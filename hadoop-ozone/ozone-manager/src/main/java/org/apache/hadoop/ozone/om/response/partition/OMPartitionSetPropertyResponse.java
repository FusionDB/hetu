...
/**
 * Response for SetPartitionProperty request.
 */
@CleanupTableInfo(cleanupTables = {PARTITION_TABLE})
public class OMPartitionSetPropertyResponse extends OMClientResponse {
  private OmPartitionInfo omPartitionInfo;

  public OMPartitionSetPropertyResponse(@Nonnull OMResponse omResponse,
  ...
  public void addToDBBatch(OMMetadataManager omMetadataManager,
    ...
    String dbPartitionKey =
        omMetadataManager.getPartitionKey(omPartitionInfo.getDatabaseName(),
                omPartitionInfo.getTableName(),
                omPartitionInfo.getPartitionName());
