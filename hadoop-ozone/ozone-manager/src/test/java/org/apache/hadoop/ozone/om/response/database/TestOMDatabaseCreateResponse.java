 ...
 */
public class TestOMDatabaseCreateResponse {
  ...
  public void testAddToDBBatch() throws Exception {
    ...
    Assert.assertEquals(hmdatabaseArgs,
        omMetadataManager.getDatabaseTable().iterator().next().getValue());
  ...
  public void testAddToDBBatchNoOp() throws Exception {
    ...
    OMResponse omResponse = OMResponse.newBuilder()
        .setCmdType(OzoneManagerProtocolProtos.Type.CreateDatabase)
        .setStatus(OzoneManagerProtocolProtos.Status.DATABASE_ALREADY_EXISTS)
        .setSuccess(false)
        .setCreateDatabaseResponse(CreateDatabaseResponse.getDefaultInstance())
        .build();

    OMDatabaseCreateResponse omDatabaseCreateResponse =
        new OMDatabaseCreateResponse(omResponse);

    try {
      omDatabaseCreateResponse.checkAndUpdateDB(omMetadataManager,
          batchOperation);
