...
public final class OzoneConsts {
  ...
  public static final String MAX_NUM_OF_TABLES = "maxNumOfTables";
  public static final String MAX_NUM_OF_PARTITIONS = "maxNumOfPartitions";
  ...
  public static final String CONTAINER_DB_TYPE_LSTORE = "LStore";
  public static final String CONTAINER_DB_TYPE_CSTORE = "CStore";
