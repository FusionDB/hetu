 ...
 */
public class TestChunkManagerDummyImpl extends AbstractTestSegmentManager {

  @Override
  protected SegmentLayoutTestInfo getStrategy() {
    return SegmentLayoutTestInfo.DUMMY;
  }
  ...
  public void dummyManagerDoesNotWriteToFile() throws Exception {
    ...
    subject.writeChunk(getLStoreContainer(), getBlockID(), getChunkInfo(),
        getData(), ctx);
  ...
  public void dummyManagerReadsAnyChunk() throws Exception {
    ...
    ChunkBuffer dataRead = dummy.readChunk(getLStoreContainer(),
