...
/**
 * This class represents the LStoreContainer metadata, which is the
 * in-memory representation of container metadata and is represented on disk
 * by the .container file.
 */
public class LStoreContainerData extends ContainerData {

  // Yaml Tag used for LStoreContainerData.
  public static final Tag LSTORE_YAML_TAG = new Tag("LStoreContainerData");
  ...
  /**
   * Number of pending deletion blocks in LStoreContainer.
   */
  ...
  public ContainerDataProto getProtoBufMessage() {
    ...
    if(this.getContainerType() != null) {
      builder.setContainerType(ContainerProtos.ContainerType.LStoreContainer);
    }
