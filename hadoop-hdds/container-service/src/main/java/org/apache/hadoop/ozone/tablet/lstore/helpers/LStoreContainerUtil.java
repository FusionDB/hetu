...
public final class LStoreContainerUtil {

  /* Never constructed. */
  private LStoreContainerUtil() {

  }

  private static final Logger LOG = LoggerFactory.getLogger(
      LStoreContainerUtil.class);
  ...
  public static void createContainerMetaData(long containerID,
    ...
    org.apache.hadoop.ozone.container.keyvalue.helpers.BlockUtils.addDB(db, dbFile.getAbsolutePath(), conf);
  }
   ...
   * @throws IOException
   */
  public static void removeContainer(LStoreContainerData containerData,
  ...
  /**
   * Parse LStoreContainerData and verify checksum. Set block related
   ...
   * @throws IOException
   */
  public static void parseKVContainerData(LStoreContainerData kvContainerData,
  ...
  private static void initializeUsedBytesAndBlockCount(DatanodeStore store,
      LStoreContainerData kvData) throws IOException {
   ...
   *
   * @param lStoreContainerData - LStoreContainerData
   * @return - Path to the chunks directory
   */
  public static Path getDataDirectory(LStoreContainerData lStoreContainerData) {
   ...
   *
   * @param lStoreContainerData - KeyValueContainerData
   * @return Path to the metadata directory
   */
  public static Path getMetadataDirectory(
        LStoreContainerData lStoreContainerData) {

    String metadataPath = lStoreContainerData.getMetadataPath();
