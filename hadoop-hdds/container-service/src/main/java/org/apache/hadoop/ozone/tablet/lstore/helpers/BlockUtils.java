...
public final class BlockUtils {
  ...
  public static DatanodeStore getUncachedDatanodeStore(
          LStoreContainerData containerData, ConfigurationSource conf,
   ...
   */
  public static ReferenceCountedDB getDB(LStoreContainerData containerData,
   ...
   * @param conf - Configuration.
   */
  public static void removeDB(LStoreContainerData container,
