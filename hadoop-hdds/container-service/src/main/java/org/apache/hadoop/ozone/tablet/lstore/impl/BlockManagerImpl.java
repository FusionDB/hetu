...
public class BlockManagerImpl implements BlockManager {
  ...
  public long putBlock(Container container, BlockData data,
    ...
    return persistPutBlock(
        (LStoreContainer) container,
        data,
        config,
        incrKeyCount);
  }

  public static long persistPutBlock(LStoreContainer container,
  ...
  public void deleteBlock(Container container, BlockID blockID) throws
    ...
    LStoreContainerData cData = (LStoreContainerData) container
        .getContainerData();
  ...
  public List<BlockData> listBlock(Container container, long startLocalID, int
    ...
    try {
      ...
      LStoreContainerData cData =
          (LStoreContainerData) container.getContainerData();
      try (ReferenceCountedDB db = BlockUtils.getDB(cData, config)) {
  ...
  /**
   * Shutdown LStoreContainerManager.
   */
  @Override
